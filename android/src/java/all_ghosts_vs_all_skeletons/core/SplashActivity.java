...
import all_ghosts_vs_all_skeletons.core.R;
...
public class SplashActivity extends Activity {
    ...
    public void proceed() {
        startActivity(new Intent("all_ghosts_vs_all_skeletons.core.MAIN"));
        finish();
    }
    ...
    public void loadClojure() {
        new Thread(new Runnable(){
                ...
                public void run() {
                    ...
                    try {
                        Class.forName("all_ghosts_vs_all_skeletons.core.AndroidLauncher");
